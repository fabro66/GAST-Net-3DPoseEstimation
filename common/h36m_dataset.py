...
class Human36mDataset(MocapDataset):
    def __init__(
        self, path, keypoints_type="cpn_ft_h36m_dbb", remove_static_joints=True
    ):
        ...
        if (
            ...
            and keypoints_type == "sh_ft_h36m"
            or keypoints_type == "sh_pt_mpii"
        ):
            ...
            for i, x in enumerate(H36M_NAMES):
                if (
                    x == "" or x == "Neck/Nose"
                ):  # Remove 'Nose' to make SH and H36M 2D poses have the same dimension
                    joints.append(i)

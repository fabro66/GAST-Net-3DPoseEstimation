...
# Joints in HumanEva dataset
HumanEva_NAMES = [''] * 15
HumanEva_NAMES[0] = 'Hip'
HumanEva_NAMES[1] = 'Thorax'
HumanEva_NAMES[2] = 'LShoulder'
HumanEva_NAMES[3] = 'LElbow'
HumanEva_NAMES[4] = 'LWrist'
HumanEva_NAMES[5] = 'RShoulder'
HumanEva_NAMES[6] = 'RElbow'
HumanEva_NAMES[7] = 'RWrist'
HumanEva_NAMES[8] = 'LHip'
HumanEva_NAMES[9] = 'LKnee'
HumanEva_NAMES[10] = 'LAnkle'
HumanEva_NAMES[11] = 'RHip'
HumanEva_NAMES[12] = 'RKnee'
HumanEva_NAMES[13] = 'RAnkle'
HumanEva_NAMES[14] = 'Neck/Nose'
